...
public class ChatActivity extends BaseActivity {
    ...
    private void init() {
        ...
        chatAdapter = new ChatAdapter(
                chatMessages,
                getBitmapForEncodedString(receiveUser.image),
        ...
        database.collection(Constants.KEY_COLLECTION_USERS).document(
            ...
            if (value != null) {
                ...
                if(receiveUser.image == null){
                    ...
                    chatAdapter.setReceiverProfileImage(getBitmapForEncodedString(receiveUser.image));
                    chatAdapter.notifyItemRangeChanged(0, chatMessages.size());
                }
            }
            if (isReceiverAvailable) {
                binding.textAvailability.setText("Online");
                binding.textAvailability.setBackgroundColor(Color.parseColor("#008000"));
                binding.textAvailability.setVisibility(View.VISIBLE);
            }else {
                binding.textAvailability.setText("Offline");
                binding.textAvailability.setBackgroundColor(Color.parseColor("#FF0000"));
                binding.textAvailability.setVisibility(View.VISIBLE);
            }
        });
    }
    ...
    private Bitmap getBitmapForEncodedString(String encodedImage) {
